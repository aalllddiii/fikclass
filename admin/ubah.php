              ...
              <div class="tile">
                  <div class="tile-body">
                      <form action="" method="post"  enctype="multipart/form-data">
                          ...
                          <?php
                          $id = $_GET['id'];
                          $sql_ubah = "SELECT * FROM  `fikclass_users` WHERE `id` = $id";
                          ...
                          <div class="row">
                            <input type="hidden" value="<?=$row['id']?>">
                              ...
                              <div class="col-12 col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="kelas" required name="fakultas" value="<?=$row['fakultas']?>"><br>
                              </div>
                              <div class="col-12 col-md-6">
